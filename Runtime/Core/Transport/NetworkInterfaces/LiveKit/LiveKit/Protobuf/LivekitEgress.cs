...
namespace LiveKit.Proto {
  ...
  public static partial class LivekitEgressReflection {
    ...
    static LivekitEgressReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChRsaXZla2l0X2VncmVzcy5wcm90bxIHbGl2ZWtpdCL8AgoaUm9vbUNvbXBv",
            "c2l0ZUVncmVzc1JlcXVlc3QSEQoJcm9vbV9uYW1lGAEgASgJEg4KBmxheW91",
            "dBgCIAEoCRISCgphdWRpb19vbmx5GAMgASgIEhIKCnZpZGVvX29ubHkYBCAB",
            "KAgSFwoPY3VzdG9tX2Jhc2VfdXJsGAUgASgJEioKBGZpbGUYBiABKAsyGi5s",
            "aXZla2l0LkVuY29kZWRGaWxlT3V0cHV0SAASJwoGc3RyZWFtGAcgASgLMhUu",
            "bGl2ZWtpdC5TdHJlYW1PdXRwdXRIABIwCghzZWdtZW50cxgKIAEoCzIcLmxp",
            "dmVraXQuU2VnbWVudGVkRmlsZU91dHB1dEgAEjAKBnByZXNldBgIIAEoDjIe",
            "LmxpdmVraXQuRW5jb2RpbmdPcHRpb25zUHJlc2V0SAESLAoIYWR2YW5jZWQY",
            "CSABKAsyGC5saXZla2l0LkVuY29kaW5nT3B0aW9uc0gBQggKBm91dHB1dEIJ",
            "CgdvcHRpb25zItwCChtUcmFja0NvbXBvc2l0ZUVncmVzc1JlcXVlc3QSEQoJ",
            "cm9vbV9uYW1lGAEgASgJEhYKDmF1ZGlvX3RyYWNrX2lkGAIgASgJEhYKDnZp",
            "ZGVvX3RyYWNrX2lkGAMgASgJEioKBGZpbGUYBCABKAsyGi5saXZla2l0LkVu",
            "Y29kZWRGaWxlT3V0cHV0SAASJwoGc3RyZWFtGAUgASgLMhUubGl2ZWtpdC5T",
            "dHJlYW1PdXRwdXRIABIwCghzZWdtZW50cxgIIAEoCzIcLmxpdmVraXQuU2Vn",
            "bWVudGVkRmlsZU91dHB1dEgAEjAKBnByZXNldBgGIAEoDjIeLmxpdmVraXQu",
            "RW5jb2RpbmdPcHRpb25zUHJlc2V0SAESLAoIYWR2YW5jZWQYByABKAsyGC5s",
            "aXZla2l0LkVuY29kaW5nT3B0aW9uc0gBQggKBm91dHB1dEIJCgdvcHRpb25z",
            ...
            "cHV0IsMCChBXZWJFZ3Jlc3NSZXF1ZXN0EgsKA3VybBgBIAEoCRISCgphdWRp",
            "b19vbmx5GAIgASgIEhIKCnZpZGVvX29ubHkYAyABKAgSKgoEZmlsZRgEIAEo",
            "CzIaLmxpdmVraXQuRW5jb2RlZEZpbGVPdXRwdXRIABInCgZzdHJlYW0YBSAB",
            "KAsyFS5saXZla2l0LlN0cmVhbU91dHB1dEgAEjAKCHNlZ21lbnRzGAYgASgL",
            "MhwubGl2ZWtpdC5TZWdtZW50ZWRGaWxlT3V0cHV0SAASMAoGcHJlc2V0GAcg",
            "ASgOMh4ubGl2ZWtpdC5FbmNvZGluZ09wdGlvbnNQcmVzZXRIARIsCghhZHZh",
            "bmNlZBgIIAEoCzIYLmxpdmVraXQuRW5jb2RpbmdPcHRpb25zSAFCCAoGb3V0",
            "cHV0QgkKB29wdGlvbnMijgIKEUVuY29kZWRGaWxlT3V0cHV0EisKCWZpbGVf",
            "dHlwZRgBIAEoDjIYLmxpdmVraXQuRW5jb2RlZEZpbGVUeXBlEhAKCGZpbGVw",
            "YXRoGAIgASgJEhgKEGRpc2FibGVfbWFuaWZlc3QYBiABKAgSHwoCczMYAyAB",
            "KAsyES5saXZla2l0LlMzVXBsb2FkSAASIQoDZ2NwGAQgASgLMhIubGl2ZWtp",
            "dC5HQ1BVcGxvYWRIABIpCgVhenVyZRgFIAEoCzIYLmxpdmVraXQuQXp1cmVC",
            "bG9iVXBsb2FkSAASJwoGYWxpT1NTGAcgASgLMhUubGl2ZWtpdC5BbGlPU1NV",
            "cGxvYWRIAEIICgZvdXRwdXQizQIKE1NlZ21lbnRlZEZpbGVPdXRwdXQSMAoI",
            "cHJvdG9jb2wYASABKA4yHi5saXZla2l0LlNlZ21lbnRlZEZpbGVQcm90b2Nv",
            "bBIXCg9maWxlbmFtZV9wcmVmaXgYAiABKAkSFQoNcGxheWxpc3RfbmFtZRgD",
            "IAEoCRIYChBzZWdtZW50X2R1cmF0aW9uGAQgASgNEhgKEGRpc2FibGVfbWFu",
            "aWZlc3QYCCABKAgSHwoCczMYBSABKAsyES5saXZla2l0LlMzVXBsb2FkSAAS",
            "IQoDZ2NwGAYgASgLMhIubGl2ZWtpdC5HQ1BVcGxvYWRIABIpCgVhenVyZRgH",
            "IAEoCzIYLmxpdmVraXQuQXp1cmVCbG9iVXBsb2FkSAASJwoGYWxpT1NTGAkg",
            "ASgLMhUubGl2ZWtpdC5BbGlPU1NVcGxvYWRIAEIICgZvdXRwdXQi4AEKEERp",
            "cmVjdEZpbGVPdXRwdXQSEAoIZmlsZXBhdGgYASABKAkSGAoQZGlzYWJsZV9t",
            ...
            "BiABKAsyFS5saXZla2l0LkFsaU9TU1VwbG9hZEgAQggKBm91dHB1dCLvAQoI",
            "UzNVcGxvYWQSEgoKYWNjZXNzX2tleRgBIAEoCRIOCgZzZWNyZXQYAiABKAkS",
            "DgoGcmVnaW9uGAMgASgJEhAKCGVuZHBvaW50GAQgASgJEg4KBmJ1Y2tldBgF",
            "IAEoCRIYChBmb3JjZV9wYXRoX3N0eWxlGAYgASgIEjEKCG1ldGFkYXRhGAcg",
            "AygLMh8ubGl2ZWtpdC5TM1VwbG9hZC5NZXRhZGF0YUVudHJ5Eg8KB3RhZ2dp",
            "bmcYCCABKAkaLwoNTWV0YWRhdGFFbnRyeRILCgNrZXkYASABKAkSDQoFdmFs",
            "dWUYAiABKAk6AjgBIjAKCUdDUFVwbG9hZBITCgtjcmVkZW50aWFscxgBIAEo",
            "DBIOCgZidWNrZXQYAiABKAkiVAoPQXp1cmVCbG9iVXBsb2FkEhQKDGFjY291",
            "bnRfbmFtZRgBIAEoCRITCgthY2NvdW50X2tleRgCIAEoCRIWCg5jb250YWlu",
            "ZXJfbmFtZRgDIAEoCSJkCgxBbGlPU1NVcGxvYWQSEgoKYWNjZXNzX2tleRgB",
            "IAEoCRIOCgZzZWNyZXQYAiABKAkSDgoGcmVnaW9uGAMgASgJEhAKCGVuZHBv",
            "aW50GAQgASgJEg4KBmJ1Y2tldBgFIAEoCSJHCgxTdHJlYW1PdXRwdXQSKQoI",
            "cHJvdG9jb2wYASABKA4yFy5saXZla2l0LlN0cmVhbVByb3RvY29sEgwKBHVy",
            "bHMYAiADKAki7QEKD0VuY29kaW5nT3B0aW9ucxINCgV3aWR0aBgBIAEoBRIO",
            "CgZoZWlnaHQYAiABKAUSDQoFZGVwdGgYAyABKAUSEQoJZnJhbWVyYXRlGAQg",
            "ASgFEigKC2F1ZGlvX2NvZGVjGAUgASgOMhMubGl2ZWtpdC5BdWRpb0NvZGVj",
            "EhUKDWF1ZGlvX2JpdHJhdGUYBiABKAUSFwoPYXVkaW9fZnJlcXVlbmN5GAcg",
            "ASgFEigKC3ZpZGVvX2NvZGVjGAggASgOMhMubGl2ZWtpdC5WaWRlb0NvZGVj",
            "EhUKDXZpZGVvX2JpdHJhdGUYCSABKAUiOAoTVXBkYXRlTGF5b3V0UmVxdWVz",
            "dBIRCgllZ3Jlc3NfaWQYASABKAkSDgoGbGF5b3V0GAIgASgJIl0KE1VwZGF0",
            "ZVN0cmVhbVJlcXVlc3QSEQoJZWdyZXNzX2lkGAEgASgJEhcKD2FkZF9vdXRw",
            "dXRfdXJscxgCIAMoCRIaChJyZW1vdmVfb3V0cHV0X3VybHMYAyADKAkiJgoR",
            "TGlzdEVncmVzc1JlcXVlc3QSEQoJcm9vbV9uYW1lGAEgASgJIjgKEkxpc3RF",
            "Z3Jlc3NSZXNwb25zZRIiCgVpdGVtcxgBIAMoCzITLmxpdmVraXQuRWdyZXNz",
            "SW5mbyImChFTdG9wRWdyZXNzUmVxdWVzdBIRCgllZ3Jlc3NfaWQYASABKAki",
            "hQQKCkVncmVzc0luZm8SEQoJZWdyZXNzX2lkGAEgASgJEg8KB3Jvb21faWQY",
            "AiABKAkSEQoJcm9vbV9uYW1lGA0gASgJEiUKBnN0YXR1cxgDIAEoDjIVLmxp",
            "dmVraXQuRWdyZXNzU3RhdHVzEhIKCnN0YXJ0ZWRfYXQYCiABKAMSEAoIZW5k",
            "ZWRfYXQYCyABKAMSDQoFZXJyb3IYCSABKAkSPQoOcm9vbV9jb21wb3NpdGUY",
            "BCABKAsyIy5saXZla2l0LlJvb21Db21wb3NpdGVFZ3Jlc3NSZXF1ZXN0SAAS",
            "PwoPdHJhY2tfY29tcG9zaXRlGAUgASgLMiQubGl2ZWtpdC5UcmFja0NvbXBv",
            "c2l0ZUVncmVzc1JlcXVlc3RIABIsCgV0cmFjaxgGIAEoCzIbLmxpdmVraXQu",
            "VHJhY2tFZ3Jlc3NSZXF1ZXN0SAASKAoDd2ViGA4gASgLMhkubGl2ZWtpdC5X",
            "ZWJFZ3Jlc3NSZXF1ZXN0SAASKQoGc3RyZWFtGAcgASgLMhcubGl2ZWtpdC5T",
            "dHJlYW1JbmZvTGlzdEgBEiEKBGZpbGUYCCABKAsyES5saXZla2l0LkZpbGVJ",
            "bmZvSAESKQoIc2VnbWVudHMYDCABKAsyFS5saXZla2l0LlNlZ21lbnRzSW5m",
            "b0gBQgkKB3JlcXVlc3RCCAoGcmVzdWx0IjMKDlN0cmVhbUluZm9MaXN0EiEK",
            "BGluZm8YASADKAsyEy5saXZla2l0LlN0cmVhbUluZm8irQEKClN0cmVhbUlu",
            "Zm8SCwoDdXJsGAEgASgJEhIKCnN0YXJ0ZWRfYXQYAiABKAMSEAoIZW5kZWRf",
            "YXQYAyABKAMSEAoIZHVyYXRpb24YBCABKAMSKgoGc3RhdHVzGAUgASgOMhou",
            "bGl2ZWtpdC5TdHJlYW1JbmZvLlN0YXR1cyIuCgZTdGF0dXMSCgoGQUNUSVZF",
            "EAASDAoIRklOSVNIRUQQARIKCgZGQUlMRUQQAiJ0CghGaWxlSW5mbxIQCghm",
            "aWxlbmFtZRgBIAEoCRISCgpzdGFydGVkX2F0GAIgASgDEhAKCGVuZGVkX2F0",
            "GAMgASgDEhAKCGR1cmF0aW9uGAYgASgDEgwKBHNpemUYBCABKAMSEAoIbG9j",
            "YXRpb24YBSABKAkinQEKDFNlZ21lbnRzSW5mbxIVCg1wbGF5bGlzdF9uYW1l",
            "GAEgASgJEhAKCGR1cmF0aW9uGAIgASgDEgwKBHNpemUYAyABKAMSGQoRcGxh",
            "eWxpc3RfbG9jYXRpb24YBCABKAkSFQoNc2VnbWVudF9jb3VudBgFIAEoAxIS",
            "CgpzdGFydGVkX2F0GAYgASgDEhAKCGVuZGVkX2F0GAcgASgDIrYBCg9BdXRv",
            "VHJhY2tFZ3Jlc3MSEAoIZmlsZXBhdGgYASABKAkSGAoQZGlzYWJsZV9tYW5p",
            "ZmVzdBgFIAEoCBIfCgJzMxgCIAEoCzIRLmxpdmVraXQuUzNVcGxvYWRIABIh",
            "CgNnY3AYAyABKAsyEi5saXZla2l0LkdDUFVwbG9hZEgAEikKBWF6dXJlGAQg",
            "ASgLMhgubGl2ZWtpdC5BenVyZUJsb2JVcGxvYWRIAEIICgZvdXRwdXQqOQoP",
            "RW5jb2RlZEZpbGVUeXBlEhQKEERFRkFVTFRfRklMRVRZUEUQABIHCgNNUDQQ",
            "ARIHCgNPR0cQAiowCg5TdHJlYW1Qcm90b2NvbBIUChBERUZBVUxUX1BST1RP",
            "Q09MEAASCAoEUlRNUBABKk4KFVNlZ21lbnRlZEZpbGVQcm90b2NvbBIjCh9E",
            "RUZBVUxUX1NFR01FTlRFRF9GSUxFX1BST1RPQ09MEAASEAoMSExTX1BST1RP",
            "Q09MEAEqLwoKQXVkaW9Db2RlYxIOCgpERUZBVUxUX0FDEAASCAoET1BVUxAB",
            "EgcKA0FBQxACKk0KClZpZGVvQ29kZWMSDgoKREVGQVVMVF9WQxAAEhEKDUgy",
            "NjRfQkFTRUxJTkUQARINCglIMjY0X01BSU4QAhINCglIMjY0X0hJR0gQAyrP",
            "AQoVRW5jb2RpbmdPcHRpb25zUHJlc2V0EhAKDEgyNjRfNzIwUF8zMBAAEhAK",
            "DEgyNjRfNzIwUF82MBABEhEKDUgyNjRfMTA4MFBfMzAQAhIRCg1IMjY0XzEw",
            "ODBQXzYwEAMSGQoVUE9SVFJBSVRfSDI2NF83MjBQXzMwEAQSGQoVUE9SVFJB",
            "SVRfSDI2NF83MjBQXzYwEAUSGgoWUE9SVFJBSVRfSDI2NF8xMDgwUF8zMBAG",
            "EhoKFlBPUlRSQUlUX0gyNjRfMTA4MFBfNjAQByqfAQoMRWdyZXNzU3RhdHVz",
            "EhMKD0VHUkVTU19TVEFSVElORxAAEhEKDUVHUkVTU19BQ1RJVkUQARIRCg1F",
            "R1JFU1NfRU5ESU5HEAISEwoPRUdSRVNTX0NPTVBMRVRFEAMSEQoNRUdSRVNT",
            "X0ZBSUxFRBAEEhIKDkVHUkVTU19BQk9SVEVEEAUSGAoURUdSRVNTX0xJTUlU",
            "X1JFQUNIRUQQBjLKBAoGRWdyZXNzElQKGFN0YXJ0Um9vbUNvbXBvc2l0ZUVn",
            "cmVzcxIjLmxpdmVraXQuUm9vbUNvbXBvc2l0ZUVncmVzc1JlcXVlc3QaEy5s",
            "aXZla2l0LkVncmVzc0luZm8SVgoZU3RhcnRUcmFja0NvbXBvc2l0ZUVncmVz",
            "cxIkLmxpdmVraXQuVHJhY2tDb21wb3NpdGVFZ3Jlc3NSZXF1ZXN0GhMubGl2",
            "ZWtpdC5FZ3Jlc3NJbmZvEkQKEFN0YXJ0VHJhY2tFZ3Jlc3MSGy5saXZla2l0",
            "LlRyYWNrRWdyZXNzUmVxdWVzdBoTLmxpdmVraXQuRWdyZXNzSW5mbxJACg5T",
            "dGFydFdlYkVncmVzcxIZLmxpdmVraXQuV2ViRWdyZXNzUmVxdWVzdBoTLmxp",
            "dmVraXQuRWdyZXNzSW5mbxJBCgxVcGRhdGVMYXlvdXQSHC5saXZla2l0LlVw",
            "ZGF0ZUxheW91dFJlcXVlc3QaEy5saXZla2l0LkVncmVzc0luZm8SQQoMVXBk",
            "YXRlU3RyZWFtEhwubGl2ZWtpdC5VcGRhdGVTdHJlYW1SZXF1ZXN0GhMubGl2",
            "ZWtpdC5FZ3Jlc3NJbmZvEkUKCkxpc3RFZ3Jlc3MSGi5saXZla2l0Lkxpc3RF",
            "Z3Jlc3NSZXF1ZXN0GhsubGl2ZWtpdC5MaXN0RWdyZXNzUmVzcG9uc2USPQoK",
            "U3RvcEVncmVzcxIaLmxpdmVraXQuU3RvcEVncmVzc1JlcXVlc3QaEy5saXZl",
            "a2l0LkVncmVzc0luZm9CRlojZ2l0aHViLmNvbS9saXZla2l0L3Byb3RvY29s",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::LiveKit.Proto.EncodedFileType), typeof(global::LiveKit.Proto.StreamProtocol), typeof(global::LiveKit.Proto.SegmentedFileProtocol), typeof(global::LiveKit.Proto.AudioCodec), typeof(global::LiveKit.Proto.VideoCodec), typeof(global::LiveKit.Proto.EncodingOptionsPreset), typeof(global::LiveKit.Proto.EgressStatus), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.RoomCompositeEgressRequest), global::LiveKit.Proto.RoomCompositeEgressRequest.Parser, new[]{ "RoomName", "Layout", "AudioOnly", "VideoOnly", "CustomBaseUrl", "File", "Stream", "Segments", "Preset", "Advanced" }, new[]{ "Output", "Options" }, null, null, null),
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.TrackCompositeEgressRequest), global::LiveKit.Proto.TrackCompositeEgressRequest.Parser, new[]{ "RoomName", "AudioTrackId", "VideoTrackId", "File", "Stream", "Segments", "Preset", "Advanced" }, new[]{ "Output", "Options" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.WebEgressRequest), global::LiveKit.Proto.WebEgressRequest.Parser, new[]{ "Url", "AudioOnly", "VideoOnly", "File", "Stream", "Segments", "Preset", "Advanced" }, new[]{ "Output", "Options" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.SegmentedFileOutput), global::LiveKit.Proto.SegmentedFileOutput.Parser, new[]{ "Protocol", "FilenamePrefix", "PlaylistName", "SegmentDuration", "DisableManifest", "S3", "Gcp", "Azure", "AliOSS" }, new[]{ "Output" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.S3Upload), global::LiveKit.Proto.S3Upload.Parser, new[]{ "AccessKey", "Secret", "Region", "Endpoint", "Bucket", "ForcePathStyle", "Metadata", "Tagging" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, }),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.EncodingOptions), global::LiveKit.Proto.EncodingOptions.Parser, new[]{ "Width", "Height", "Depth", "Framerate", "AudioCodec", "AudioBitrate", "AudioFrequency", "VideoCodec", "VideoBitrate" }, null, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.ListEgressRequest), global::LiveKit.Proto.ListEgressRequest.Parser, new[]{ "RoomName" }, null, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.EgressInfo), global::LiveKit.Proto.EgressInfo.Parser, new[]{ "EgressId", "RoomId", "RoomName", "Status", "StartedAt", "EndedAt", "Error", "RoomComposite", "TrackComposite", "Track", "Web", "Stream", "File", "Segments" }, new[]{ "Request", "Result" }, null, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.StreamInfo), global::LiveKit.Proto.StreamInfo.Parser, new[]{ "Url", "StartedAt", "EndedAt", "Duration", "Status" }, null, new[]{ typeof(global::LiveKit.Proto.StreamInfo.Types.Status) }, null, null),
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::LiveKit.Proto.SegmentsInfo), global::LiveKit.Proto.SegmentsInfo.Parser, new[]{ "PlaylistName", "Duration", "Size", "PlaylistLocation", "SegmentCount", "StartedAt", "EndedAt" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public global::LiveKit.Proto.EncodingOptionsPreset Preset {
      get { return optionsCase_ == OptionsOneofCase.Preset ? (global::LiveKit.Proto.EncodingOptionsPreset) options_ : global::LiveKit.Proto.EncodingOptionsPreset.H264720P30; }
      set {
        options_ = value;
